...
public class CuttingRecipes
{
        ...
        // These recipes generate as cutting recipes (in cutting/ folder) to match FDR.
        // Previously called .salvaging() which incorrectly produced duplicate salvaging/ copies,
        // shadowing the cutting versions on the cutting board (6 duplicates: amethyst_block,
        // bricks, deepslate, nether_bricks, quartz_block, stone). Do NOT add .salvaging() back.
