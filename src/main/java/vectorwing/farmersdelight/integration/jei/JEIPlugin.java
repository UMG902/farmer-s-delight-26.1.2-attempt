...
public class JEIPlugin implements IModPlugin
{
	...
	public void registerRecipes(IRecipeRegistration registration) {
		...
		registration.addRecipes(FDRecipeTypes.COOKING, List.copyOf(modRecipes.getCookingPotRecipes()));
		registration.addRecipes(FDRecipeTypes.CUTTING, List.copyOf(modRecipes.getCuttingBoardRecipes()));
